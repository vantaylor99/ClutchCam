...
- [Real OBS connection checkpoint](real-obs-connection.md): verify a live OBS
  host, scene set, and non-destructive preflight before any real switching.
...
- The real-OBS checkpoint is connection-only; ingest, live transcription, and
  AI switching stay disabled for that pass.
